...
class BooksApp extends React.Component {
  ...
  render() {
    ...
    // {title: "Best Android Apps", subtitle: "The Guide for Discriminating Downloaders", authors: Array(2), publisher: ""O'Reilly Media, Inc."", publishedDate: "2010-04-27", …}allowAnonLogging: falseauthors: (2) ["Mike Hendrickson", "Brian Sawyer"]averageRating: 4canonicalVolumeLink: "https://books.google.com/books/about/Best_Android_Apps.html?hl=&id=bUybAgAAQBAJ"categories: ["Computers"]contentVersion: "preview-1.0.0"description: "Contains descriptions of over two hundred recommended applications and games for android/mobile devices, including apps for business, communication, lifestyle, entertainment, utility/tool, and reference."id: "bUybAgAAQBAJ"imageLinks: {smallThumbnail: "http://books.google.com/books/content?id=bUybAgAAQ…J&printsec=frontcover&img=1&zoom=5&source=gbs_api", thumbnail: "http://books.google.com/books/content?id=bUybAgAAQ…J&printsec=frontcover&img=1&zoom=1&source=gbs_api"}industryIdentifiers: (2) [{…}, {…}]infoLink: "http://books.google.com/books?id=bUybAgAAQBAJ&dq=android&hl=&source=gbs_api"language: "en"maturityRating: "NOT_MATURE"pageCount: 240previewLink: "http://books.google.com/books?id=bUybAgAAQBAJ&dq=android&hl=&cd=1&source=gbs_api"printType: "BOOK"publishedDate: "2010-04-27"publisher: ""O'Reilly Media, Inc.""ratingsCount: 3readingModes: {text: false, image: false}subtitle: "The Guide for Discriminating Downloaders"title: "Best Android Apps"__proto__: Object
